...
function __OriginkitBase_GlitterWrap(props: Props) {
...
export default function GlitterWrap(props: Partial<Props>) {
  const merged: Props = { ...COMPONENT_DEFAULTS, ...__originkitPresetProps, ...props }
  return <__OriginkitBase_GlitterWrap {...merged} />;
}
